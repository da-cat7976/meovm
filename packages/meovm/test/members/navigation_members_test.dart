...
class NavigationMembersTests {
  ...
  void _navigationMemberUseNavigation() {
    testWidgets(
      'NavigationMember.useNavigation triggers callback on data change',
      (tester) async {
  ...
  void _modalFlowMemberRequestAndComplete() {
    testWidgets(
      'ModalFlowMember request -> callback -> notifyCompleted updates listeners',
      (tester) async {
        final vm = _ModalVm();
  ...
  void _modalFlowMemberDoubleRequestReturnsSameFuture() {
    testWidgets(
      'ModalFlowMember reuses the same pending request (single callback invocation)',
      (tester) async {
        final vm = _ModalVm();
            ...
            child: ViewModelDispatcher(
              ...
              child: HookBuilder(
                builder: (context) {
                  ...
                  return Text(
                    'calls=${calls.value}',
                    key: const ValueKey('modal_calls'),
                  );
                },
              ),
            ),
  ...
  void _modalFlowMemberResetShouldClose() {
    testWidgets(
      'ModalFlowMember.reset completes pending request with null and clears state',
      (tester) async {
        final vm = _ModalVm();
              ...
              body: ViewModelDispatcher(
                ...
                child: HookBuilder(
                  builder: (context) {
                    ...
                    final text =
                        'requested=${vm.modal.isModalRequested}; result=${vm.modal.result}';
